...
export default async function Home() {
  ...
  return (
    <main className="container relative flex  flex-col gap-8 px-4 pt-16">
        ...
        Object.entries(habits).map(([habitName, habitStreak]) => (
          <div key={habitName} className="flex flex-col gap-2">
            <div className="flex justify-between items-center">
              ...
              <DeleteButton habit={habitName} />
            </div>
            <Link href={`habito/${habitName}`}>
      ...
      <Link
        href="novo-habito"
        className="fixed text-center bottom-10 w-3/4 left-1/2 -translate-x-1/2
         text-neutral-900 bg-[#45EDAD] font-display font-regular 
